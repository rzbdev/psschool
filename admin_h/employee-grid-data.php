...
//////////////////////////////
include_once("config2.php"); // Database Connection 
...
$check="select * from notification where status='1'";
$res_check=mysql_query($check);
$check_count=mysql_num_rows($res_check);
if($check_count>0)
{
	 $queryy .=" 1=1 AND Notification='$noti' AND ";
	 $query .=" ORDER BY ".$column." ".$order.""; 

$q="select count(id) from personal_details  where ".$queryy." post_applied IN (select title  from jobs where nid IN(SELECT nid FROM notification where status='1')) ". $query ;
	 
$query1= "select * from personal_details  where ".$queryy." post_applied IN (select title  from jobs where nid IN(SELECT nid FROM notification where status='1')) ". $query . "  limit $start_record,$limit " ;
     ...
     $query_h= "select * from personal_details  where ".$queryy." post_applied IN (select title  from jobs where nid IN(SELECT nid FROM notification where status='1')) ". $query ;
}
else
{
	$queryy .=" 1=1 AND Notification='$noti' AND ";
...
$q="select count(id) from personal_details  where ".$queryy." post_applied IN (select title  from jobs where nid IN(SELECT nid FROM notification where date_ex < '$current_date' order by date_ex desc)) ". $query ;
	 
$query1= "select * from personal_details  where ".$queryy." post_applied IN (select title  from jobs where nid IN(SELECT nid FROM notification where date_ex < '$current_date' order by date_ex desc)) ". $query . "  limit $start_record,$limit " ;
     ...
     $query_h= "select * from personal_details  where ".$queryy." post_applied IN (select title  from jobs where nid IN(SELECT nid FROM notification where date_ex < '$current_date' order by date_ex desc)) ". $query ;
}
