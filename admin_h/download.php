...
header("Expires: 0");
 ...
 echo "A.";
	...
	echo "Applicant Image";
		print "\t";
		$schema_insert = "";
         $schema_insert ="http://careers.pathseekers.education/uploads/".$row['image'];
	...
	echo "Name of Applicant";
		print "\t";
		$schema_insert = "";
     $schema_insert = 'Mr. '.ucfirst($row['first_name']).' '.ucfirst($row['last_name']);
	  print(trim($schema_insert));
	print "\n";
			 }
		 else
	...
	echo "Name of Applicant";
		print "\t";
		$schema_insert = "";
     $schema_insert ='Mrs. '.ucfirst($row['first_name']).' '.ucfirst($row['last_name']);
	  print(trim($schema_insert));
	print "\n";
		 }
	...
	echo "Husband Name";
		print "\t";
		$schema_insert = "";
     $schema_insert ='Mr.'.ucwords(strtolower($row['husband']));
	...
	echo "Father's Name";
		print "\t";
		$schema_insert = "";
     $schema_insert = 'Mr.'.ucwords(strtolower($row['father_name']));
	  print(trim($schema_insert));
	print "\n";
...
echo " ";
	...
	echo "Monthly Income of Spouse";
		...
		{
	$schema_insert = "";
  $schema_insert ='Rs.'.$ro['monthly_income'].'/-';
	  print(trim($schema_insert));
	  print "\n";
		}
	$sql5= "Select * from  dependent_member_detail where id= '$d_id'";
$result5= mysql_query($sql5);
 $ro5= mysql_fetch_array($result5);  
...
if($rown['period_from']!='')
	...
	echo "";
		print "\t";
		$schema_insert = "";
      	    $schema_insert =' '.$rowna['no_of_year'].' year as an '.ucwords(strtolower($rowna['responsibilities'])).' in  '.ucwords(strtolower($rowna['school']));
	  print(trim($schema_insert));
	print "\n";
...
WHERE id = '$d_id'
           ...
           $result21 = mysql_query($sql121);
           $rows= mysql_fetch_array($result21);
...
echo " ";
	...
	echo "Present Post/Designation";
	  ...
	  print "\n"; 
			...
			print "\t";
	  $schema_insert = "";
      $schema_insert = $row['present_salary'];
	  print(trim($schema_insert));
	  print "\n";
...
$dem=mysql_num_rows($res);
$rowso= mysql_fetch_array($res);
              $n=$rowso['name'];
if($n!='')
{
		    echo " ";
