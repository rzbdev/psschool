...
<div class="container-fluid">
 ...
 <?php 
		...
		<!---<button type="submit" class="btn srch" name="search">Search</button>-->
		 ...
		 <div class="col-md-4 col-sm-6">
			...
			<select class="form-control" onchange="ajaxFunction('');" name="" id="job" placeholder="Quick Search">
			 ...
			 <?php 
			 $selec="select * from jobs where nid IN(SELECT nid FROM notification WHERE date_ex >= DATE_FORMAT(NOW(),'%Y-%m-%d'))";
	        	$r=mysql_Query($selec);
	...
	?>
		...
		<?php 	  $select1="SELECT *  FROM notification WHERE date_ex >= DATE_FORMAT(NOW(),'%Y-%m-%d')";
	$row1=mysql_Query($select1);
  
	while($ro=mysql_fetch_array($row1))
	{
		?>
	...
	{
		?>
				<a href="#"  id="download" class="btn srch rght">Download All</a>
	<?php
	}
	?>
			 <a style="float:right;" href="old_applicants1.php?page=1"><button type="button" class="btn  btn-lg srch rght1">OLD APPLICANTS</button></a>
			...
			<div id="" class="result11">
				...
				<div class="col-md-12 margin-top">
				  <b>Note</b>: Showing information Of applicants that applied to the active notification.<br><br>Abbreviations:<br>E:Eligible , NE:Non-Eligible , NR:Non-Rated. </div>
				</div>
