...
if(isset($_POST['submit']))
{
	...
	$query = mysqli_query("UPDATE `admin_login` SET `email`='$email',`password`='$password' ,`name`='$name' WHERE alid = '$alid'");
	if($query)
	{	
...
<div class="wrapper">
	...
	<div class="form-group">
	   ...
	   <div class="form-group">
		...
		<button class="btn btn-blue load" name="submit" type="submit">SAVE</button>
		</p>
		</div>
      </form>
        </div>
