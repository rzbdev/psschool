...
<div class="wrapper">
			<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
						    <h6><a href="../Notification.php"><span class="bell"><img src="images/bell.png" /></span>Notification Detail </a></h6>
		...
		<a class="accordion-toggle toggle_link collapsed"  href="#" data-check="1">
					...
					$select="SELECT * FROM jobs WHERE nid IN(SELECT nid FROM notification WHERE status='1')";
							...
							$rows_state=mysqli_query($select_state);
...
$('.next').click(function(e){
  ...
  return $(this).css('display') !== 'none';
	...
	{
		sectionValid = false;
		//alert('Please ensure that you have added your complete education as it may affect your elegibility.');
	}
	if(data_next_top==='4')
	{
...
var diffDays = (firstDate.getTime() - secondDate.getTime())/(oneDay);
  ...
  <script>
  $(function() {
var date = $('#person_dob').datepicker({changeMonth: true, maxDate: 0 ,changeYear: true,yearRange: '1900:+0', dateFormat: 'dd/mm/yy' , onClose: function() {$(this).valid(); }}).val();
