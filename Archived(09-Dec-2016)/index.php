...
$result1=mysqli_query($con,$sql_date1);													
// deactivate notification
$sql_de="select * from notification where status='1'";
$deact=mysqli_query($con,$sql_de);
...
$result=mysqli_query($con,$update_deact);
}	
?>
<html lang="en">
  <head>
...
<div class="wrapper">
			<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
						    <h6><a href="notification39.html"><span class="bell"><img src="images/bell.png" /></span>Notification Detail </a></h6>
							<h1>Application for teaching/non teaching staff</h1>
						</div>
					</div>
					</div><!---header----->
		...
		<a class="accordion-toggle toggle_link collapsed"  href="#" data-check="1">
								    ...
								    <div class="">
									  ...
									  <div class="col-md-6 pdngrht">
										  ...
										  <div class="form-group">
										   ...
										   <div class="col-md-6 pdngrht">
										  <div class="form-group">
											<label for="Post" class="col-md-5 control-label pdngrht">Post Applied For<span class="red">*</span></label>
											<div class="col-md-7">
											 <select class="form-control" name="apply_post" id="apply_post" >
											 <option value="">Select Post</option>
												  <?php 
							
					$select="SELECT * FROM jobs WHERE nid IN(SELECT nid FROM notification WHERE status='1')";
							...
							?>
										  ...
										  <div class="form-group">
											...
											<div class="col-md-8 smtp">
											  <input type="text" class="form-control" name="person_dob" id="person_dob" placeholder="dd/mm/yyyy" >
											</div>
										  </div>
										  </div>
										  <div class="col-md-6 pdngrht">
										  <div class="form-group">
											...
											<div class="col-md-7">
											  <input type="email" class="form-control" name="mail" id="mail" placeholder="name@email.com" >
											</div>
										  </div>
										  </div>
										  <div class="col-md-6 pdngrht">
										  ...
										  <div class="col-md-5 pdngrht">
										   <div class="form-group">
											...
											<div class="col-md-7 lftpdng mbp mbprght">
											  <input type="text" class="form-control lftpdng commonField" name="mnum" id="mnum" placeholder="Enter mobile no." >
											</div>
										  </div>
										  </div>
										   <div class="col-md-7 pdngrht">
							...
							$rows_state=mysqli_query($con,$select_state);
							 $r=mysqli_num_rows($rows_state);
							while($row=mysqli_fetch_array($rows_state))
							{
							?>
...
<Button class="btn success-btn pull-right next" data-id="1" name="submit" type="button" style="margin-top:0px;">Next</button>
						  ...
						  <div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed"  href="#" data-check="2">
								<h4 class="panel-title">
						  ...
						  <div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed"  href="#" data-check="3">
								<h4 class="panel-title">
						  ...
						  <div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed" href="#" data-check="4">
								<h4 class="panel-title">
						    ...
						    <div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed"  href="#" data-check="5">
								<h4 class="panel-title">
						   ...
						   <div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed"  href="#" data-check="6">
								 <h4 class="panel-title">
...
in an Organization (In chronological order starting with the most recent) <span data-id="tab_logic5" class="plus add_row15"><a class="add nw1">Add Experience</a></span></h4>
                 ...
                 (As class coordinator, activity coordinator, examination dept. head, CCE coordinator)<span data-id="tab_logic4" class="plus add_row152"><a class="add nw1">Add Experience</a></span></h4>
						 ...
						 <div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed" href="#" data-check="7">
								<h4 class="panel-title">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed" href="#" data-check="8">
								 <h4 class="panel-title">
						   ...
						   <div class="panel panel-default">
							<div class="panel-heading">
								<a class="accordion-toggle toggle_link collapsed"  href="#" data-check="9">
								 <h4 class="panel-title">
					...
					<label for="Name" class="col-md-6 control-label linehghtt2 lyft">(If Yes, Please Give Details):<span class="red">*</span></label>
						<div class="col-md-6 lftpdng">
										  <input type="text" class="form-control mtsm commonField" id="casedetail" name="case_detail" placeholder="Please mention the criminal case detail">
										</div>
					</div>
				</div><!--col-md-12-->
								  </div>
					...
					<label for="Name" class="col-md-6 control-label linehght1 lyft">(If Yes, Please Give Details):<span class="red">*</span></label>
						<div class="col-md-6 lftpdng">
										  <input type="text" class="form-control mtsm commonField" id="chargedetail" name="charge_detail" placeholder="Please mention the criminal charge detail">
										</div>
					</div>
				</div><!--col-md-12-->
									  </div>
...
Hospital units of MJSMRS or any other society of Dera (Details Thereof)?<span class="red">*</span></label>
					...
					<label for="Name" class="col-md-6 control-label linehght1 lyft"></label>
						<div class="col-md-6 lftpdng">
										  <input type="text" class="form-control mtsm commonField" id="earlier_employed1" name="earlier_employed_detail" placeholder="Please mention details">
										</div>
					</div>
				</div><!--col-md-12-->
									  </div>
					...
					<div class="clearfix"></div>
					 ...
					 <div id="cap">
					   <div class="col-md-3 pdngrht">
						  <div class="col-md-1"></div>
						  <div class="col-md-9" >
					<div class="g-recaptcha" data-sitekey="6LcHDx4TAAAAALfhZMyDjXkJfE5D4YLbzJQPneet" data-theme="light" data-size="normal"></div>
						 </div>
						 </div>
						  <div style="color:red;font-weight:bold;display:none;position:absolute;top:25px;left:385px;" class="response_res ">Please Fill the Captcha</div>
						 </div>
...
function validateEmail(sEmail) {
  ...
  <script>
	...
	$(document).on('change','.fileInput',function(){
          ...
          if( size > 5242880){
             alert('Please upload Image less than 5MB file');
