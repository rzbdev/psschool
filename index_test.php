			...
			<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
						    <h6><a href="notification60.html"><span class="bell"><img src="images/bell.png" /></span>Notification Detail </a></h6>
							<h1>Application for Teaching and Non - Teaching Staff</h1>
						</div>
					</div>
					</div><!---header----->
