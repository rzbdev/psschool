...
$password= base64_encode($_POST['password']);
 $Name= $_POST['Name'];
  ...
  {
	 $query = mysql_query("INSERT INTO `admin_login`(`email`, `password`,`user_type`,`name`) VALUES ('$email','$password','2','$Name')");
	$query1 = mysql_query("INSERT INTO `manage_email`(`email`, `alid`,`name`,`post`,`email_send`,`status`) VALUES ('$email','$alid','$Name','$chk11','$chk22','$chk33')");
	}
	}
	else
	{
  ...
  {
		 $query = mysql_query("INSERT INTO `admin_login`(`email`, `password`,`user_type`,`name`) VALUES ('$email','$password','1','$Name')");
		 $query1 = mysql_query("INSERT INTO `manage_email`(`email`, `alid`,`name`,`post`,`email_send`,`status`) VALUES ('$email','$alid','$Name','$chk11','$chk22','$chk33')");
	}
	}
