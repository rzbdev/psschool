	...
	else
	{
		echo " ";
				  ...
				  <td colspan="3" style="padding:12px 15px;">Address Detail</td>
					...
					<tr>
					 <td>
					     <b>Address Line1 </b>: <?php echo $address; ?>
					 <br><b>Address Line2 </b>: <?php echo  $per_address1;?>
					 <br><b>City </b>: <?php echo  $city;?>
					   <br><b>Pincode </b>: <?php echo $pin;?>
					   <br><b>State </b>: <?php echo  $state;?>
					   <br><b>Country </b>: <?php echo  $country;?>
						<br><b>Telephone </b>: <?php echo $per_mobile1;  ?>
						<br><b>Mobile No. </b>: <?php echo $tele_no;  ?>
						
					 </td>
					 <td><b>Address Line1 </b>: <?php echo $communication_address; ?>
					 <br><b>Address Line2 </b>: <?php echo  $comm_address1;?>
					 <br><b>City </b>: <?php echo  $comm_city;?>
					 <br><b>Pincode </b>: <?php echo $comm_pin;?>
					 <br><b>State </b>: <?php echo  $comm_state;?>
					<br><b>Country </b>: <?php echo  $comm_country;?>
					<br><b>Phone </b>: <?php echo $comm_telephoneno;  ?>
					</td>
					<td>
							<?php echo $MARITAL;  ?>
					</td>
